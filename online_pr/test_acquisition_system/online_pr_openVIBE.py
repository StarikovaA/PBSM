...
np.save('eeg_samples_ov.npy', eeg_samples)
np.save('eeg_timestamps_ov.npy', eeg_timestamps)
np.save('marker_samples_ov.npy', marker_samples)
np.save('marker_timestamps_ov.npy', marker_timestamps)
np.save('corrected_marker_timestamps_ov.npy', corrected_marker_timestamps)
# %%
